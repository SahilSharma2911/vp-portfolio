import { bounceAnimation, bounceAnimationImage, staggeredAnimationFast } from "~/utils/animations";
  ...
  return (
    <Container className="relative mt-12 z-10 ">
      <motion.dl
        ...
        className="lg:grid lg:grid-cols-2 lg:py-8  "
      >
